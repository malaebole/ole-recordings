...
function renderPlaylist(category = "all") {
  ...
  const cameraOne = `https://recorder.ole-app.ae/api/camera-1/recordings?booking_id=${bookingId}`;
  const cameraTwo = `https://recorder.ole-app.ae/api/camera-2/recordings?booking_id=${bookingId}`;
  if (!bookingId) {
